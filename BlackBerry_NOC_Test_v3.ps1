...
$IaminRussia = 0                                                          # <<<<< Set 0 if you are not in Russia. Установи 1 если ты находишься в России и проверять блокировку Роскомнадзором необходимо.
$DirectConnectServers = ""                                                # <<<<< Type here all your Direct Connect Servers comma separated

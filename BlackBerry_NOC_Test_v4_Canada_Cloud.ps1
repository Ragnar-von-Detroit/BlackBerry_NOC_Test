...
$country = "ca"                                                            # <<<<<< 'ca' = Canada | 'ru' = Russia | 'us' = United States only (US)
...
foreach ($server in $BlackBerryServers) {
    # Clean variables
    $ServerURLcolor = ""; $ServerURL = ""; $ServerPort1 = ""; $ServerPort2 = ""; $ServerBlockIP = ""; $ServerBlockDomain = ""; $ServerBlockIPcolor = ""; $ServerBlockDomainColor = ""; $Blocking = ""; $ServerLatencycolor = ""; $ServerPortColor1 = ""; $ServerPortColor2 = ""
    ...
    #$Report.Add("<tr><td bgcolor='#7FCEDF' style='padding: 5px;' align=center><b>$ServerName</b></td> <td style='padding: 5px;' align=center>$ServerCNAME</td> $ServerPingHTML $ServertelnetHTML $ServerBlockIPHTML $Blocking<td $ServerURLcolor style='padding: 5px;' align=center>$ServerURL</td><td style='padding: 5px;' align=center>$ServerDescription</td></tr>")
